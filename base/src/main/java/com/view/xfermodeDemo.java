...
/**
 * Created by zhangjunjun on 2017/5/16.
 */

public class xfermodeDemo extends ImageView {
    ...
    public xfermodeDemo(Context context) {
        this(context, null);
    ...
    public xfermodeDemo(Context context, AttributeSet attrs) {
        super(context, attrs);
